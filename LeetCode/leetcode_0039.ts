...
candidates, сумма которых равна target. Комбинации могут быть в любом порядке.
...
Тестовые случаи генерируются таким образом, что количество уникальных комбинаций, сумма которых равна target,
меньше 150 комбинаций для данного входного значения.
